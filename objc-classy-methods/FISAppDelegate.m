...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSString *katerineHepburn = [katherine stringByAppendingString:@" Hepburn"];
    NSLog(@"%@",katerineHepburn);
    ...
    NSArray *classyDrinks = [NSArray arrayWithObjects:@"Old Fashioned", @"Churchill Martini", @"Presecco", nil];
    NSLog(@"%@", classyDrinks);
